...
export default {
  ...
  chat: {
    ...
    contextSettingsTitle: 'Context Window Management',
    contextTooltip: 'Token count of history messages in current session context',
    ...
    contextSaved: 'Context config saved',
  },
}
